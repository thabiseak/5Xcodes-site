...
export const products: Product[] = [
  {
    ...
    pricing: {
      basic: { price: 99, features: ['Up to 10 workflows', 'Basic analytics', 'Email support'] },
      premium: { price: 299, features: ['Unlimited workflows', 'Advanced analytics', 'Priority support', 'Custom integrations'] },
      enterprise: { price: 999, features: ['Everything in Premium', 'Dedicated support', 'Custom development', 'SLA guarantee'] },
    },
  ...
  },
  {
    ...
    pricing: {
      basic: { price: 149, features: ['5 dashboards', 'Basic charts', 'Monthly reports'] },
      premium: { price: 399, features: ['Unlimited dashboards', 'Advanced charts', 'Real-time data', 'Custom reports'] },
      enterprise: { price: 1299, features: ['Everything in Premium', 'White-label solution', 'Custom development', 'Training & support'] },
    },
  ...
  },
  {
    ...
    pricing: {
      basic: { price: 199, features: ['1000 conversations/month', 'Basic AI model', 'Email support'] },
      premium: { price: 499, features: ['10,000 conversations/month', 'Advanced AI model', 'Priority support', 'Custom training'] },
      enterprise: { price: 1999, features: ['Unlimited conversations', 'Custom AI model', 'Dedicated support', 'White-label solution'] },
    },
...
export const services: Service[] = [
  {
    ...
    pricing: { starting: '$10,000', description: 'Starting price for small projects' },
    featured: true,
  },
  {
    id: '2',
    ...
    caseStudies: ['E-Commerce Platform Modernization', 'Healthcare Data Analytics Platform'],
    pricing: { starting: '$5,000', description: 'Starting price for cloud migration' },
    featured: true,
  },
  {
    id: '3',
    ...
    pricing: { starting: '$15,000', description: 'Starting price for AI integration projects' },
    featured: true,
  },
  {
    id: '4',
    ...
    pricing: { starting: '$8,000', description: 'Starting price for mobile app development' },
    featured: true,
  },
]
